...
local json = (loadfile "/home/bibak/INLINE/JSON.lua")()
 ...
 if redis:get(hash) then
    ...
    return false
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'[🔖Send Your Msg🔖](https://telegram.me/virus32)',keyboard)
            end
							------------------------------------------------------------------------
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'[✔️Send Your Problem✔️](https://telegram.me/virus32)',keyboard)
            end
							------------------------------------------------------------------------
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'[❗️Send Your Offer❗️](https://telegram.me/virus32)',keyboard)
            end
							------------------------------------------------------------------------
